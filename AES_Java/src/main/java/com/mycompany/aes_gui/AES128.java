...
public class AES128 {
    ...
    public static String[][] keyExpansion(String[][] initialisationKey) {
        ...
        // Sao chép khóa gốc vào 4 cột đầu của expandKey
        for (int i = 0; i < 4; i++) {
            for (int j = 0; j < 4; j++) {
    ...
    public static void main(String[] args) {
        String plaintext = "Phạm Việt Long";
        String key = "phamvietlong1504";
        String ciphertext = encrypt_hex(plaintext, key);
